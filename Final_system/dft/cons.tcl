...
create_clock -name "dft_clk" -period 10000 -waveform {0 5000} [get_ports scan_clk]
set_clock_uncertainty -setup $CLK_SETUP_SKEW [get_clock dft_clk]
set_clock_uncertainty -hold $CLK_HOLD_SKEW [get_clock dft_clk]
...
set_dont_touch_network [get_clocks dft_clk]
set_dont_touch_network [get_ports scan_rst]
set_dont_touch_network [get_clocks $CLK_NAME]
set_dont_touch_network [get_ports RST]
set_dont_touch_network [get_ports U2/OUT]
#set_dont_touch_network [get_clocks mux_clk]
...
set_clock_groups -asynchronous -group [get_clocks "dft_clk"] -group [get_clocks "REF_CLK ALU_CLK"]
set_clock_groups -asynchronous -group [get_clocks "dft_clk"] -group [get_clocks "UART_CLK TX_CLK RX_CLK"]
